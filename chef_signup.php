        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="chef_world/chef_home.php">Recipes</a>
                    </li>
                </ul>
                ...
                <div class="col-12 col-lg-9 col-xl-7">
                    <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                        <div class="card-body p-4 p-md-5">
                            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Chef Registration Form</h3>
                            <form action="chef_signup.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4 d-flex align-items-center">
                                        ...
                                        <div class="form-outline datepicker w-100">
                                            <input type="text" name="chefid" class="form-control form-control-lg"
                                                id="birthdayDate" />
                                            <label for="birthdayDate" class="form-label">Chef ID</label>
                                        </div>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" name="gender" type="radio"
                                                name="inlineRadioOptions" id="otherGender" value="Others" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-4 pb-2">
                                        ...
                                        <div class="form-outline">
                                            <input type="file" id="phoneNumber" name="pic"
                                                class="form-control form-control-lg" />
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <select name="cuisinetype" class="select form-control-lg">
                                            <option value="Bangaldeshi">Bangladeshi</option>
...
{   $chefid=$_POST['chefid'];
	...
	$query="insert into chef_table values('$chefid','$fname', '$lname','$email','$mob','$image','$cuisinetype','$gender','$pass')";
	if(mysqli_query($con,$query))
	{
		echo "Successfully inserted!";
		if($image !=null){
	                move_uploaded_file($_FILES['pic']['tmp_name'],"images/chef_images/$image");
                    }
    }
	else
	{
