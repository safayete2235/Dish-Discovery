...
if (isset($_GET['recipeid'])) {
    ...
    $sql = "SELECT recipeid,postdate,pic,preparationtime,recipename,description,ingredients,steps FROM recipe_table where recipeid='$session_recipeid'";
...
if(isset($_POST['updaterecipe'])){
    	...
    	if(mysqli_query($con,$query))
    	{
            ...
            unset($_SESSION['preparationtime']);
            ...
            echo '<script>window.location.href = "chef_home.php";</script>';
