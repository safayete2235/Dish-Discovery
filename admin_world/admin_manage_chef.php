...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="admin_manage_chef.php">Manage Chef</a>
                    </li>
                    <li class="nav-item">
    ...
    if(isset($_GET['LtoO']) and $_GET['LtoO']=="click") {
        ...
        if(mysqli_num_rows($r) > 0){
            ...
            { 
                ...
                echo "    </td>";
                echo "    <td>";
                echo "<a class='btn btn-link btn-rounded btn-sm fw-bold' href='admin_delete_chef_and_user.php?chefid=$chefid'>Delete</a>";
                echo "    </td>";
                echo "</tr>";
            }
        }  
    ...
    if(mysqli_num_rows($r) > 0){
        while($row = mysqli_fetch_array($r))
        {
            ...
            echo "    </td>";
            echo "    <td>";
            echo "        <span class='rounded-pill d-inline'>$cuisinetype</span>";
            echo "    </td>";
            echo "    <td>";
            echo "           <p class='fw-normal mb-1'>$email</p>";
            echo "    </td>";
