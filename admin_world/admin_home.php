...
<body>
    ...
    <div class="container-fluid px-4 py-5 my-5 text-center">
        <div class="lc-block mb-4">
            <div editable="rich">
                <h2 class='display-2 fw-bold'>Hello <span class='text-primary'>Mohammed!</span></h2>
            </div>
        </div>
            ...
            if(isset($_POST['search-btn'])){
                ...
                if(mysqli_num_rows($r) > 0){
                    while($row = mysqli_fetch_array($r))
                    {
                        ...
                        echo "<a href='admin_recipe_details.php?recipeid=$recipeid'class='btn btn-primary'>Read More</a>";
                        echo "</div>";
                        echo "</div>";
                    }
                } else {
